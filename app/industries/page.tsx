...
export default function IndustriesPage() {
  return <main id="main-content"><InnerHero kicker="INDUSTRIES WE SERVE" title="Technology requirements differ by operating environment." intro="These sectors represent markets where our services can be applied. They do not imply completed client work in every industry; each engagement starts with the specific organization and its needs." />
