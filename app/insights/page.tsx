...
export const metadata = createPageMetadata({ title: "Insights", description: "Dawood Technologies perspectives on engineering, cloud, cybersecurity, data, AI and business technology.", path: "/insights" });
