        ...
        <section style={{ maxWidth: "760px" }}>
          ...
          >
            <p style={{ margin: "0 0 7px 0" }}>
              ...
              adaptability, communication skills, and a broad perspective
              toward people and opportunities.
            </p>
          ...
          >
            A personalized local AI assistant designed for personal
            productivity, cybersecurity workflows, documentation, meetings, and
            workplace support. Built around open-source LLM systems and
            continuously improved through customized workflows, contextual
            learning, and user-specific requirements.
          </p>
