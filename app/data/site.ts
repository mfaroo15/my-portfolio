...
export const whatsappLabel = "Let's Talk";
...
export const capabilities = [
  {
    code: "01", slug: "ai-automation", title: "AI & Automation",
  ...
  {
    code: "02", slug: "cloud-devops", title: "Cloud & DevOps",
  ...
  {
    code: "03", slug: "application-development", title: "Application Development",
  ...
  {
    code: "04", slug: "enterprise-erp", title: "Enterprise & ERP",
  ...
  {
    code: "05", slug: "data-services", title: "Data Services",
  ...
  {
    code: "06", slug: "cybersecurity", title: "Cybersecurity",
  ...
  {
    code: "07", slug: "managed-technology", title: "Managed Technology",
...
export const industries = [
  ...
  { code: "07", title: "Retail & E-commerce", text: "Connected commerce, customer, inventory and reporting experiences across physical and digital channels.", needs: ["Commerce platforms", "CRM", "System integration", "Customer analytics"] },
  { code: "08", title: "Manufacturing & Infrastructure", text: "Business applications, operational systems, reporting and digital infrastructure for production-led organizations.", needs: ["Business applications", "Operational visibility", "Reporting", "Digital infrastructure"] },
  { code: "09", title: "Construction", text: "Project workflows, business applications, data visibility and cloud platforms for coordinated delivery.", needs: ["Project workflows", "Business systems", "Reporting", "Cloud platforms"] },
  { code: "10", title: "Logistics & Supply Chain", text: "Tracking systems, integrations, reporting and data platforms for complex operational movement.", needs: ["Tracking systems", "Integrations", "Operational reporting", "Data platforms"] },
  { code: "11", title: "International Trade & Commerce", text: "Business systems, operational workflows, data management and commerce technology for international coordination.", needs: ["Business systems", "Digital presence", "Data management", "Automation"] },
] as const;
